"""create profile_prerequisites

Revision ID: 20260423_0026
Revises: 20260423_0025
...
revision: str = "20260423_0026"
down_revision: Union[str, None] = "20260423_0025"
...
def upgrade() -> None:
    if _has_table("profile_prerequisites"):
    ...
    op.create_table(
        ...
        sa.Column("prerequisite", sa.String(length=255), nullable=False),
    ...
    op.create_index(
        op.f("ix_profile_prerequisites_user_profile_id"),
        "profile_prerequisites",
        ["user_profile_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_profile_prerequisites_user_profile_id"), table_name="profile_prerequisites")
    op.drop_table("profile_prerequisites")
